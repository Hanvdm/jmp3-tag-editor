...
/**
 * This class maps an ASF simple index object.
 *
 * @author Giuseppe Miscione
 *
 */
public class ASFSimpleIndexObject extends ASFGenericObject {

    /**
     * Creates a new instance of an ASF simple index object.
     *
     ...
     */
    public ASFSimpleIndexObject(ASFObjectGUID guid, long length, InputStream data) throws InvalidObjectDataException {
