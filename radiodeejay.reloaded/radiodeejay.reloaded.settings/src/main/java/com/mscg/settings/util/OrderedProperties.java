...
package com.mscg.settings.util;
 ...
 * <a name="encoding"></a>
 * <p>
 * The {@link #load load} and {@link #store store} methods load and store
 ...
 * represented in this encoding can be written using <a
 * href="http://java.sun.com/docs/books/jls/html/3.doc.html#100850">Unicode
 * escapes</a> ; only a single 'u' character is allowed in an escape sequence.
 ...
 * @since JDK1.0
 */
public class OrderedProperties extends TreeMap<Object, Object> {
    /**
     * use serialVersionUID from JDK 1.1.X for interoperability
     */
    private static final long serialVersionUID = -543223492978825590L;
     ...
     * @param comment
     *            a description of the property list, or <code>null</code> if no
     *            comment is desired.
     * @throws IOException
     ...
     *
     * <p>
     * If the specified comment is <code>null</code> then no comment will be
     ...
     *             <tt>IOException</tt>.
     * @throws NullPointerException
     *             if <code>os</code> is <code>null</code>, or if
    ...
    public synchronized void storeToXML(OutputStream os, String comment, String encoding) throws IOException {
        ...
        Properties tmp = new Properties();
        tmp.putAll(this);
        tmp.storeToXML(os, comment, encoding);
    }
