...
public class ASFExtendedContentDescriptionObject extends ASFGenericObject {

    public ASFExtendedContentDescriptionObject(ASFObjectGUID guid, long length, InputStream data)
