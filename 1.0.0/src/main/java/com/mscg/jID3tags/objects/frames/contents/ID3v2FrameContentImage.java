...
public class ID3v2FrameContentImage implements ID3v2FrameContent {
    ...
    public ID3v2FrameContentImage(StringEncodingType encoding, String mimeType, PictureType pictureType, String description,
                                  byte[] pictureData) {
    ...
    public byte[] getBytes() {
        ...
        try {
            // Write the text encoding byte
            bos.write(encoding.toByte());

            // Write the mime type plus a trailing zero byte
            ...
            // Write the description plus a trailing zero byte
            bos.write(Util.encodeString(getDescription(), getEncoding()));
            bos.write(0);

            // Write the picture raw data
    ...
    public String toString() {
        return "image mime type: " + getMimeType() + ", image type: " + getPictureType().toString() +
               ", description: " + getDescription() + ", binary data length: " + getPictureData().length;
    }
