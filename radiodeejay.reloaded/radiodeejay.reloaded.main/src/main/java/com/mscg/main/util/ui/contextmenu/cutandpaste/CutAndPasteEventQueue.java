...
public class CutAndPasteEventQueue extends EventQueue {
    protected void dispatchEvent(AWTEvent event) {
        ...
        CutAction cutAction = new CutAction(tc, localization.getString("contextmenu.cut"));
        cutAction.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, InputEvent.CTRL_DOWN_MASK));
        CopyAction copyAction = new CopyAction(tc, localization.getString("contextmenu.copy"));
        copyAction.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, InputEvent.CTRL_DOWN_MASK));
        PasteAction pasteAction = new PasteAction(tc, localization.getString("contextmenu.paste"));
        pasteAction.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, InputEvent.CTRL_DOWN_MASK));
        DeleteAction deleteAction = new DeleteAction(tc, localization.getString("contextmenu.delete"));
        deleteAction.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, InputEvent.CTRL_DOWN_MASK));
        SelectAllAction selectAllAction = new SelectAllAction(tc, localization.getString("contextmenu.selectall"));
